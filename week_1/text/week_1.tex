...
We used the following code,
\lstinputlisting[title=\texttt{matrix/extractcols.cc}]{../ex5/matrix/extractcols.cc}
\lstinputlisting[title=\texttt{matrix/extractrows.cc}]{../ex5/matrix/extractrows.cc}
\lstinputlisting[title=\texttt{matrix/functor1.cc}]{../ex5/matrix/functor1.cc}
\lstinputlisting[title=\texttt{matrix/functor2.cc}]{../ex5/matrix/functor2.cc}
\lstinputlisting[title=\texttt{matrix/functor3.cc}]{../ex5/matrix/functor3.cc}
\lstinputlisting[title=\texttt{matrix/operatorextract.cc}]{../ex5/matrix/operatorextract.cc}
\lstinputlisting[title=\texttt{matrix/operatorinsert.cc}]{../ex5/matrix/operatorinsert.cc}
