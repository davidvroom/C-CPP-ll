...
\lstinputlisting[caption=\texttt{Output of main1.cc},language=bash, numbers=none]{../ex11/outputMain1.txt}
...
\lstinputlisting[caption=\texttt{Output of main2.cc},language=bash, numbers=none]{../ex11/outputMain2.txt}
